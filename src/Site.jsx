...
export default function Site() {
  ...
  return (
    <div className="overflow-hidden bg-gray-950 min-h-screen flex flex-col items-center justify-start pt-22 sm:justify-center sm:pt-0 relative isolate">
      <div
        aria-hidden="true"
        ...
        <div className="relative isolate px-6 lg:px-8 w-full max-w-4xl text-center z-10">
          <div className="mx-auto max-w-lg py-16 sm:py-24 lg:py-32">
            ...
            <div className="text-center mt-5">
              ...
              <p className="mt-6 sm:mt-8 text-lg font-medium text-pretty text-gray-300 ">
