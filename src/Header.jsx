...
import { xwanimate, stagger } from "motion";
      ...
      <div className="relative isolate px-6 pt-5 lg:px-8">
        ...
        <div className="mx-auto max-w-lg py-32 sm:py-48 lg:py-56">
          ...
          <div class="mb-4 flex justify-center">
            <div class="relative rounded-full px-3 py-1 text-xs md:text-base text-gray-500 transition duration-200 ease-in-out ring-1 ring-gray-800 hover:ring-gray-700 focus:outline-none hover:scale-98 drop-shadow-lg drop-shadow-indigo-500/30 hover:drop-shadow-indigo-900/50">
              <a
              ...
              >
                ...
                <span class=" text-indigo-500">
                  <span class="absolute inset-0" aria-hidden="true"></span>click
          ...
          <div className="text-center mt-5">
            ...
            <div className="mt-10 flex items-center justify-center gap-x-6">
              <button className="bg-indigo-700 hover:bg-indigo-600 hover:scale-97 transition duration-200 ease-in-out rounded-xl px-5 py-3 w-60">
                <a
                  href="#"
