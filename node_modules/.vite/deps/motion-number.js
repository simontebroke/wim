...
// node_modules/motion-number/dist/es/components/AnimateNumber.mjs
...
// node_modules/motion-number/dist/es/utils/format-parts.mjs
var formatToParts = (value, { locales, format }, prefix, suffix) => {
...
// node_modules/motion-number/dist/es/components/Mask.mjs
var import_jsx_runtime12 = __toESM(require_jsx_runtime(), 1);
var maskHeight = "var(--mask-height, 0.15em)";
var maskWidth = "var(--mask-width, 0.5em)";
var correctedMaskWidth = `calc(${maskWidth} / var(--invert-x, 1))`;
var cornerGradient = `#000 0, transparent 71%`;
var mask = (
  // Horizontal:
  `linear-gradient(to right, transparent 0, #000 ${correctedMaskWidth}, #000 calc(100% - ${correctedMaskWidth}), transparent),linear-gradient(to bottom, transparent 0, #000 ${maskHeight}, #000 calc(100% - ${maskHeight}), transparent 100%),radial-gradient(at bottom right, ${cornerGradient}),radial-gradient(at bottom left, ${cornerGradient}), radial-gradient(at top left, ${cornerGradient}), radial-gradient(at top right, ${cornerGradient})`
);
var maskSize = `100% calc(100% - ${maskHeight} * 2),calc(100% - ${correctedMaskWidth} * 2) 100%,${correctedMaskWidth} ${maskHeight},${correctedMaskWidth} ${maskHeight},${correctedMaskWidth} ${maskHeight},${correctedMaskWidth} ${maskHeight}`;
addScaleCorrector({
  "--invert-x": {
...
function Mask({ children }) {
  return (0, import_jsx_runtime12.jsx)(motion.span, { layout: true, "aria-hidden": true, style: {
    display: "inline-flex",
    ...
    // for zIndex
    zIndex: -1,
    // should be underneath everything else
    overflow: "clip",
    // important so it doesn't affect page layout
...
// node_modules/motion-number/dist/es/components/NumberSection.mjs
var import_jsx_runtime15 = __toESM(require_jsx_runtime(), 1);
var import_react57 = __toESM(require_react(), 1);

// node_modules/motion-number/dist/es/hooks/use-is-initial-render.mjs
var import_react50 = __toESM(require_react(), 1);
function useIsInitialRender() {
  const isInitialRender = (0, import_react50.useRef)(true);
...
// node_modules/motion-number/dist/es/utils/get-width-in-ems.mjs
function getWidthInEm(element) {
  const { width, fontSize } = getComputedStyle(element);
  return `${parseFloat(width) / parseFloat(fontSize)}em`;
}

// node_modules/motion-number/dist/es/utils/target-widths.mjs
var targetWidths = /* @__PURE__ */ new WeakMap();

// node_modules/motion-number/dist/es/components/NumberDigit.mjs
var import_jsx_runtime13 = __toESM(require_jsx_runtime(), 1);
var import_react52 = __toESM(require_react(), 1);
var NumberDigit = (0, import_react52.forwardRef)(function NumberDigit2({ value: _value, initialValue: _initialValue = _value, ...rest }, _ref) {
  const { transition } = (0, import_react52.useContext)(MotionConfigContext);
  const initialValue = (0, import_react52.useRef)(_initialValue).current;
  const isInitialRender = useIsInitialRender();
  const scope = (0, import_react52.useRef)(null);
  const ref = (0, import_react52.useRef)(null);
  (0, import_react52.useImperativeHandle)(_ref, () => ref.current, []);
  const numberRefs = (0, import_react52.useRef)(new Array(10));
  const isPresent2 = useIsPresent();
  const value = isPresent2 ? _value : 0;
  ...
  const prevValue = (0, import_react52.useRef)(_initialValue);
  (0, import_react52.useLayoutEffect)(() => {
    var _a;
    if (!scope.current || value === prevValue.current)
      return;
    const box = scope.current.getBoundingClientRect();
    const refBox = (_a = ref.current) == null ? void 0 : _a.getBoundingClientRect();
  ...
  const [width, setWidth] = (0, import_react52.useState)();
  ...
  const renderNumber = (i) => (0, import_jsx_runtime13.jsx)("span", { style: {
    display: "inline-block",
    padding: `calc(${maskHeight}/2) 0`
  }, ref: (r) => void (numberRefs.current[i] = r), children: i }, i);
  return (0, import_jsx_runtime13.jsx)(motion.span, { ...rest, ref, layout: "position", "data-state": isPresent2 ? void 0 : "exiting", style: {
    display: "inline-flex",
    justifyContent: "center",
    width
  }, children: (0, import_jsx_runtime13.jsxs)("span", { ref: scope, style: {
    display: "inline-flex",
    justifyContent: "center",
    flexDirection: "column",
    alignItems: "center",
    position: "relative"
  }, children: [value !== 0 && (0, import_jsx_runtime13.jsx)("span", { style: {
    ...digitFillStyle,
    bottom: `100%`,
    left: 0
  }, children: new Array(value).fill(null).map((_, i) => renderNumber(i)) }), renderNumber(value), value !== 9 && (0, import_jsx_runtime13.jsx)("span", { style: {
    ...digitFillStyle,
    top: `100%`,
    left: 0
...
// node_modules/motion-number/dist/es/components/NumberSymbol.mjs
var import_jsx_runtime14 = __toESM(require_jsx_runtime(), 1);
var import_react55 = __toESM(require_react(), 1);

// node_modules/motion-number/dist/es/components/SectionContext.mjs
var import_react53 = __toESM(require_react(), 1);
var SectionContext = (0, import_react53.createContext)({
  justify: "left"
});

// node_modules/motion-number/dist/es/components/NumberSymbol.mjs
var NumberSymbol = (0, import_react55.forwardRef)(function NumberSymbol2({ partKey, type, children, ...rest }, ref) {
  const isPresent2 = useIsPresent();
  const { justify } = (0, import_react55.useContext)(SectionContext);
  return (0, import_jsx_runtime14.jsx)(motion.span, { ...rest, "data-state": isPresent2 ? void 0 : "exiting", style: {
    display: "inline-flex",
    justifyContent: justify,
    padding: `calc(${maskHeight}/2) 0`,
    // match digits
    position: "relative"
    // needed for AnimatePresent popLayout
  }, layout: "position", ref, children: (0, import_jsx_runtime14.jsx)(AnimatePresence, { mode: "popLayout", anchorX: justify, initial: false, children: (0, import_jsx_runtime14.jsx)(motion.span, { layout: justify === "right" ? "position" : false, initial: { opacity: 0 }, animate: { opacity: [null, 1] }, exit: { opacity: [null, 0] }, style: {
    display: "inline-block",
    whiteSpace: "pre"
    // some symbols are spaces or thin spaces
  }, children }, children) }) });
});

// node_modules/motion-number/dist/es/components/NumberSection.mjs
var NumberSection = (0, import_react57.forwardRef)(function NumberSection2({ parts, justify = "left", mode, style, name, ...rest }, _ref) {
  const ref = (0, import_react57.useRef)(null);
  (0, import_react57.useImperativeHandle)(_ref, () => ref.current, []);
  const context = (0, import_react57.useMemo)(() => ({ justify }), [justify]);
  const measuredRef = (0, import_react57.useRef)(null);
  const isInitialRender = useIsInitialRender();
  ...
  return (0, import_jsx_runtime15.jsx)(SectionContext.Provider, { value: context, children: (0, import_jsx_runtime15.jsx)(motion.span, { ...rest, ref, className: `number-section-${name}`, style: {
    ...style,
    display: "inline-flex",
    justifyContent: justify,
    width
  }, children: (0, import_jsx_runtime15.jsxs)("span", { ref: measuredRef, style: {
    display: "inline-flex",
    justifyContent: "inherit",
    position: "relative"
    // needed for AnimatePresent popLayout
  }, children: ["​", (0, import_jsx_runtime15.jsx)(AnimatePresence, { mode, anchorX: justify, initial: false, children: parts.map((part) => part.type === "integer" || part.type === "fraction" ? (0, import_jsx_runtime15.jsx)(NumberDigit, { initial: { opacity: 0 }, animate: { opacity: 1 }, exit: { opacity: 0 }, value: part.value, initialValue: isInitialRender ? void 0 : 0 }, part.key) : (0, import_jsx_runtime15.jsx)(NumberSymbol, { type: part.type, partKey: part.key, initial: { opacity: 0 }, animate: { opacity: 1 }, exit: { opacity: 0 }, children: part.value }, part.type === "literal" ? `${part.key}:${part.value}` : part.key)) })] }) }) });
});
...
var DEFAULT_TRANSITION = {
  ...
  // perceptual duration of 0.5s
  layout: { type: "spring", duration: 1, bounce: 0 },
  y: { type: "spring", duration: 1, bounce: 0 }
};
var AnimateNumber = (0, import_react59.forwardRef)(function AnimateNumber2({ children: value, locales, format, transition, style, suffix, prefix, ...rest }, ref) {
  const parts = (0, import_react59.useMemo)(() => formatToParts(value, { locales, format }, prefix, suffix), [value, locales, format]);
  const { pre, integer, fraction, post, formatted } = parts;
  const contextTransition = (0, import_react59.useContext)(MotionConfigContext).transition;
  transition = transition ?? contextTransition ?? DEFAULT_TRANSITION;
  return (0, import_jsx_runtime16.jsx)(LayoutGroup, { children: (0, import_jsx_runtime16.jsx)(MotionConfig, { transition, children: (0, import_jsx_runtime16.jsx)(motion.div, { ...rest, ref, layout: true, style: {
    lineHeight: 1,
    // make this one easy to override
    ...style,
    display: "inline-flex",
    isolation: "isolate",
    // so number can be underneath first/last
    whiteSpace: "nowrap"
  }, children: (0, import_jsx_runtime16.jsxs)(motion.div, { layout: true, "aria-label": formatted, style: {
    display: "inline-flex",
    direction: "ltr",
    // I think this is needed b/c numbers are always LTR?
    isolation: "isolate",
    // so number can be underneath pre/post
    position: "relative",
    zIndex: -1
    // so the whole number is under any first/last
    // userSelect: "none", // I think adding this to the parent then undoing it on the selectable one might work a little better
    // pointerEvents: "none",
  }, children: [(0, import_jsx_runtime16.jsx)(NumberSection, { style: { padding: `calc(${maskHeight}/2) 0` }, "aria-hidden": true, justify: "right", mode: "popLayout", parts: pre, name: "pre" }), (0, import_jsx_runtime16.jsxs)(Mask, { children: [(0, import_jsx_runtime16.jsx)(NumberSection, { justify: "right", parts: integer, name: "integer" }), (0, import_jsx_runtime16.jsx)(NumberSection, { layout: "position", parts: fraction, name: "fraction" })] }), (0, import_jsx_runtime16.jsx)(NumberSection, { style: { padding: `calc(${maskHeight}/2) 0` }, "aria-hidden": true, layout: "position", mode: "popLayout", parts: post, name: "post" })] }) }) }) });
});
export {
  AnimateNumber
};
//# sourceMappingURL=motion-number.js.map
